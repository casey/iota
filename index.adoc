...
The IOTA wallet requires users to manually enter an 81 character seed, instead of securely generating one. This led users to use malicious online seed generators, leading to the theft of almost $4 million in funds. ^<<seed-generators>>^
...
- [[seed-generators]] https://twitter.com/nic__carter/status/954950774534090752[Tweet], https://cryptofundamental.com/@nic__carter[Nic Carter]
